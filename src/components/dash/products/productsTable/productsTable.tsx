...
function ProductsList() {
    ...
    const paginatedItems = useMemo(() => pagination(products, +itemPerPage, current), [current, itemPerPage, products])
    const prev = () => {
        if (current > 0) {
    ...
    return (
        <>
            <div className={"overflow-x-auto w-full h-[500px] overflow-y-auto no-scrollbar"}>
