...
function CartItems() {
    ...
    return (
        <div className={"col-span-4 max-md:col-span-full row-span-5 flex flex-col gap-5 bg-primary ring-2 ring-zinc-800 rounded-lg shadow shadow-black p-5 max-sm:p-2"}>
            {
                cartItems.length > 0 ?
