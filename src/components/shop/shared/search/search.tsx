...
function Search() {
    ...
    return (
        <div>
            <CgSearch onClick={() => setIsOpen(true)}
                      className={"cursor-pointer text-2xl max-sm:text-xl light:max-md:text-black"}/>
            <AnimatePresence>
                {
                    isOpen && (
                        <>
                            ...
                            <span
                                ...
                                <div
                                    className={"bg-secondary rounded-lg ring ring-gold px-3 py-2 w-1/3 max-lg:w-2/3 max-md:w-3/4 flex items-center gap-2"}>
                                    <input className={"w-full outline-none border-none bg-transparent text-black flex-1"}
