        ...
        <section className={"w-full h-screen flex items-center justify-center relative p-10"}>
            ...
            <div className={"grid grid-cols-2 justify-items-center  p-10"}>
                ...
                <div className={"flex flex-col gap-8 "}>
                    ...
                    <p className={"text-white line-clamp-3 p-2 "}>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت
                    ...
                    <button className={"py-3 px-8 rounded-md bg-gold text-white/80 shadow shadow-black self-start"}>همین
                        حالا خرید کنید
                    </button>
                </div>
            </div>
            <div
                className={"absolute -translate-x-1/2 left-1/2 bottom-20 text-white/70  flex items-center gap-4 self-end"}>
